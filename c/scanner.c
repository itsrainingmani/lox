...
// Utility function to test the rest of a potential keyword's lexeme
...
static TokenType identifierType() {
  // trie structure for recognizing keywords
...
static Token identifier() {
  ...
  // we keep consuming alphanumerics until we run out of them.
  while (isAlpha(peek()) || isDigit(peek())) advance();

  // we then produce a token with the proper "type"
